...
const zhCN = {
  ...
  'report.core-quality.des': '代码质量图能展示出当前项目下所有应用的代码质量详情，这有助于您了解到每个应用的质量情况。',
  ...
  'report.deploy-duration.des': '部署时长图能展示该项目下某一环境中各个应用部署时长等部署相关的信息，这有助于您了解项目中各个应用的部署情况。',
  'report.deploy-times.des': '部署次数图能展示出该项目下各个环境中各个应用的部署频率，这将帮助您了解团队的部署频次与整体的效率。',
  'report.build-number.head': '构建次数图',
  'report.build-number.des': '构建次数图将从应用的维度为您展示任意时间段某个应用的构建次数，构建成功次数以及构建成功率。这将帮助您快速地定位构建出现的问题，同时直观地了解到项目中某个应用的构建情况。',
  'report.date': '日期',
  ...
  'report.build-duration.des': '构建时长图将从应用的维度为您展示所选时间段某个应用每一次构建的时长，这将帮助您更为直观地了解应用构建的效率。',
