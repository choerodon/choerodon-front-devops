    ...
    const formContent = (<div className="c7n-region">
      {this.state.type === 'create' ? <div>
        ...
        <p>
          ...
          <a href="http://v0-5.choerodon.io/zh/docs/user-guide/development-pipeline/application-management/" rel="nofollow me noopener noreferrer" target="_blank" className="c7n-external-link">
        ...
        { AppStore.isRefresh ? <LoadingBar display /> : <React.Fragment>
          ...
          <div className="page-content">
            ...
            <p>
              ...
              <a className="c7n-external-link" href="http://v0-5.choerodon.io/zh/docs/user-guide/development-pipeline/application-management/" rel="nofollow me noopener noreferrer" target="_blank">
                <span className="c7n-external-link-content">
                  了解详情
                </span>
                <span className="icon-open_in_new" />
