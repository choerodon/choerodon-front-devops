  ...
  render() {
    ...
    const content = (<div className="page-content">
      ...
      <p>
        ...
        <a href="http://v0-5.choerodon.io/zh/docs/user-guide/development-pipeline/branch-management/" rel="nofollow me noopener noreferrer" className="c7n-external-link">
