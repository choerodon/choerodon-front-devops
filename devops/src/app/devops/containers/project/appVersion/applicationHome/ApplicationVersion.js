      ...
      <div className="c7n-region page-container c7n-appVersion-wrapper">
        {AppVersionStore.isRefresh ? <Loadingbar display /> : <React.Fragment>
          ...
          <div className="page-content">
            ...
            <p>
              这些权限会影响此项目及其所有资源。
              <a href="http://v0-5.choerodon.io/zh/docs/user-guide/development-pipeline/application-version/" rel="nofollow me noopener noreferrer" target="_blank" className="c7n-external-link">
