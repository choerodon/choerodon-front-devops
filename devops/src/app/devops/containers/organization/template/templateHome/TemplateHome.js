    ...
    const formContent = (<div className="c7n-region">
      {this.state.type === 'create' ? <div>
        ...
        <p>
          ...
          <a href="http://v0-5.choerodon.io/zh/docs/user-guide/development-pipeline/application-template/" rel="nofollow me noopener noreferrer" target="_blank" className="c7n-external-link">
